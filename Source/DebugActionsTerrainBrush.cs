...
namespace QuickTerrainBrush
{
    public static class DebugActionsTerrainBrush
    {
        [DebugAction("Map", "Terrain brush (4x4)", false, false, false, false, false, 0, false, allowedGameStates = AllowedGameStates.PlayingOnMap, displayPriority = 91)]
        private static List<DebugActionNode> TerrainBrush4x4()
        {
            return CreateTerrainBrushNodes(4);
        }

        [DebugAction("Map", "Terrain brush (8x8)", false, false, false, false, false, 0, false, allowedGameStates = AllowedGameStates.PlayingOnMap, displayPriority = 90)]
        private static List<DebugActionNode> TerrainBrush8x8()
        {
            return CreateTerrainBrushNodes(8);
        }

        [DebugAction("Map", "Terrain brush (16x16)", false, false, false, false, false, 0, false, allowedGameStates = AllowedGameStates.PlayingOnMap, displayPriority = 89)]
        private static List<DebugActionNode> TerrainBrush16x16()
        {
            return CreateTerrainBrushNodes(16);
        }

        [DebugAction("Map", "Terrain brush (32x32)", false, false, false, false, false, 0, false, allowedGameStates = AllowedGameStates.PlayingOnMap, displayPriority = 88)]
        private static List<DebugActionNode> TerrainBrush32x32()
        {
            return CreateTerrainBrushNodes(32);
        }

        [DebugAction("Map", "Terrain brush (64x64)", false, false, false, false, false, 0, false, allowedGameStates = AllowedGameStates.PlayingOnMap, displayPriority = 87)]
