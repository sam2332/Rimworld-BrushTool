...
namespace Verse
{
    public static class TerrainBrushNodeFactory
    {
        public static List<DebugActionNode> CreateTerrainBrushNodes(float brushRadius)
        {
            ...
            foreach (TerrainDef terrain in terrains)
            {
                ...
                list.Add(new DebugActionNode(localTerrain.LabelCap)
                {
                    action = delegate
                    {
                        TerrainBrushToolFactory.CreateBrushToolForTerrain(localTerrain, localBrushRadius);
                    }
                });
            }
